...
callback!(
...
) do n_clicks, n_periods, sumsy_gincome, sumsy_demfree, sumsy_dem, sumsy_seed, n_consumers, n_bakers, n_tv_merchants
    ...
    model = init_loreco_model(SuMSy(sumsy_gincome, sumsy_demfree, sumsy_dem/100, 30, seed = sumsy_seed),
